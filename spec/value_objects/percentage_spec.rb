...
RSpec.describe Percentage do
  describe 'initialization' do
    it 'creates a percentage from a decimal (0.25 = 25%)' do
      percent = described_class.new(0.25)
  ...
  describe 'of method' do
    it 'calculates percentage of a number' do
      percent = described_class.new(0.2)  # 20%
      expect(percent.of(100)).to eq(20)
    end

    it 'calculates percentage of Money' do
      percent = described_class.new(0.1)  # 10%
  ...
  describe 'arithmetic' do
    it 'adds two percentages' do
      p1 = described_class.new(0.1)  # 10%
      p2 = described_class.new(0.05) # 5%
      result = p1 + p2
      expect(result.value).to eq(described_class.new(0.15).value)
    end
  end
end
